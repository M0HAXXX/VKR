...
Условия: l_ap ≤ l_sh, a < b"""
    ...
    РЕЗУЛЬТАТЫ:
    • График - наглядное представление освещенности
